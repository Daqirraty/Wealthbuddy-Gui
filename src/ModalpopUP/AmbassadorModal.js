...
const AmbassadorPops = () =>{
    ...
    return(
        <div className="relative z-10 transition-opacity" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div className="fixed inset-0 bg-[#E5E5E5] bg-opacity-80">
                <div className="fixed z-10 inset-0 overflow-y-auto border">
                    <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
                        <div className="relative border-8 bg-white rounded-[2.5rem]  overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full">
                                ...
                                <div className="justify-center sm:flex sm:items-start">
                                    <div className="mt-3 justify-center sm:mt-0 sm:ml-4 sm:text-left">
                                        ...
                                        {/* <div className="bg-white mx-auto justify-center px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                            <Link to={`/`}>
                                                <button type="button" onClick={()=>setShowApplynowModal(false)} className="bg-[#99BF18] w-[224px] h-[54px] mt-3 inline-flex justify-center sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm text-white font-medium py-2 mb-2 px-6 border rounded-lg hover:border-blue-400 items-center">
