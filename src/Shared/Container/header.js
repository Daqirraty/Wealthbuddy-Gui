  ...
  return(
    <div >
      {/* Start of navbar */}
        ...
        {/* BEGIN FOOTER */}
        <footer class="flex flex bg-[#99BF18] md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
            ...
            <ul class="flex flex items-center md:none mt-3 text-sm sm:mt-0">
                <li className='flex'><a href="#" class="mr-4 md:mr-6 "><img src={facebook}/></a></li>
                {/* <li className='flex'><Link to={``} class="mr-4 md:mr-6 "><img src={facebook}/></Link></li> */}
                <li className='flex'><a href="#" class="mr-4 md:mr-6"><img src={Instagram}/></a></li>
                {/* <li className='flex'><Link to={``} class="mr-4 md:mr-6 "><img src={Instagram}/></Link></li> */}
                <li className='flex'><a href="#" class="mr-4 md:mr-6"><img src={twitter}/></a></li>
                {/* <li className='flex'><Link to={``} class="mr-4 md:mr-6 "><img src={twitter}/></Link></li> */}
                <li className='flex'><a href="#" class="mr-4 md:mr-6"><img src={linkedin}/></a></li>
                {/* <li className='flex'><Link to={``} class="mr-4 md:mr-6 "><img src={linkedin}/></Link></li> */}
