...
const applyNow = () =>{
    return(
        <Container>
            ...
            <div className="container flex flex mx-[5rem] mt-[3rem]">
                <div className="mt-[9rem]">
                    <form action="/Applynow" className="w-[32rem]">
                    ...
                    <div className=''  >
                        ...
                        <div className="my-3">
                            ...
                            <label for="radio3" className="ml-1">No</label>
                            <input type ="radio" id="radio4" name="criminalrecord" value="Yes" className='ml-5 mb-2 border border-[#99BF18]'></input>
                            <label for="radio4" className="ml-1">Yes</label>
                        </div>
                        <div className='mb-[2rem] '>
                            <input type ="radio" id="radio5" name="termsandcond" className='bg-[#99BF18]'></input>&nbsp;&nbsp;
                            <label for="radio5">I agree to the terms & conditions of this application</label>
                        </div>

                        <Link to={`/Modal`}>
                            <button className="flex flex bg-[#99BF18] w-[180px]  h-[54px] mb-[4rem] text-white font-bold py-2 mb-2 px-6 border-2 rounded-lg hover:border-blue-400 inline-flex items-center">
